...
public class Main extends QMainWindow {
    ...
    /**
     * Create a new show. If appropriate prompt the user to save first, and
     * then open a blank show
     */
    public void newShow() {
    ...
    /**
     * Open an existing show. If appropriate prompt the user to save first,
     * then open an existing show
     */
    ...
    /**
     * Save the show to existing location. If the show has already been
     * saved, save to this location, otherwise prompt the user for a
     * location.
     */
    ...
    /**
     * Save the show to a new location. Prompt the user for a location to
     * save to.
     */
