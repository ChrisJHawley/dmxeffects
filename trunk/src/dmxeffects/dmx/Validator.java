...
public class Validator {
     ...
     *                The type of validation to perform. This should either
     *                be a NUM_VALIDATION or VAL_VALIDATION.
    ...
    /**
     * Method to validate a channel number, which should be between 1 and
     * 512 inclusive.
     * 
