...
public class Generator {
	...
	/**
	 * Method to return the current instance of Generator, creating a new one if
	 * necessary.
	 * 
	...
	/**
	 * Method to generate a single random value upon a specified channel number,
	 * leaving the other values unchanged.
	 * 
	 * @throws InvalidChannelNumberException
	 *             Exception thrown indicating the channelNumber does not follow
	 *             the specification.
	 ...
	 * 
	 * @param channelNumber
	 *            The number of the channel to insert the data upon. This should
	 *            be between 1 and 512 inclusive.
	 * @param channelValue
	 *            The value to insert onto the specified channel. This should be
	...
	/**
	 * Method to generate a single channel value. This should be from 0 to 255
	 * inclusive.
	 * 
