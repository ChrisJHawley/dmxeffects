...
/**
 * Exception to be thrown when a DMX Channel Number that is provided, is not
 * valid.
 * 
 * @author chris
 */
public class InvalidChannelNumberException extends java.lang.Exception {
	...
	/**
	 * Creates a new instance of <code>InvalidChannelNumberException</code>
	...
	/**
	 * Constructs an instance of <code>InvalidChannelNumberException</code>
