...
public class Universe extends QObject {
    ...
    /**
     * Signal indicating a channel-value pair has updated. First Integer is
     * the channel number. Second Integer is the channel value.
     */
    public Signal2<Integer, Integer> dmxValueUpdater = new Signal2<Integer, Integer>();

    /**
     * Signal indicating the removal of an association range. First Integer
     * is the first channel number. Second Integer is the size of the range.
     */
    public Signal2<Integer, Integer> assocRemUpdater = new Signal2<Integer, Integer>();

    /**
     * Signal indicating the update of an association. Integer is the
     * channel number. String is the module name or an empty string if no
     * module.
     */
    ...
    /**
     * Method to set the value of a channel in the Universe to a specific
     * value based upon some input.
     * 
     * @param channelNumber
     *                The channel number that the value applies to. This
     *                ranges from 1 to 512.
     * @param channelValue
     *                The value that the channel is set to. This ranges from
     *                0 to 255.
     * @throws InvalidChannelNumberException
     *                 Exception for when the channelNumber does not follow
     *                 the specification.
     * @throws InvalidChannelValueException
     *                 Exception for when the channelValue does not follow
     *                 the specification.
     */
     ...
     * 
     * @param channelNumber
     *                The channel number for which the value should be
     *                returned. This ranges from 1 to 512.
     ...
     * associated with. This will include other modules, or perhaps just a
     * light that the user wishes to label.
     * 
     * @param channelNumber
     *                The number of the channel for which the association
     *                exists.
     * @param associatedElement
     *                A String naming the element for which the association
     *                end.
     * @throws InvalidChannelNumberException
    ...
    /**
     * Get the name of the element associated with the specified channel
     * number.
     * 
     * @param channelNumber
     *                The number of the channel for which the association
     *                exsists.
     * @return The String naming the element for which the association
     *         exists.
